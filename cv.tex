...
\begin{entrylist}
  \entry
    ...
    {Formation en ligne Udacity, entrainement avec les tutoriels tensorflow et scikit. \\Classification d'images avec réseau de neuronnes à convolution. Transfer learning en réentrainant l'architecture InceptionV3 pour des nouvelles catégories.\\Concours ImageCLEF2017, CrowdAi, Kaggle.\\ Premiers tests de manipulation de fichiers DICOM.\\}
